...
Examples:
  ...
  steampipe query "select * from cloud"`,
	...
	cmdconfig.
		...
		AddStringFlag(constants.ArgTheme, "", "plain", "Set the output theme, which determines the color scheme for the syntax highlighting. Possible values are light, dark, plain.").
